...
import {AlertCircle, Building2, Calendar, DollarSign, Link as LinkIcon, Loader2, Unlink} from 'lucide-react';
                  ...
                  Balance as of {format(new Date(account.balance_as_of), 'MMM d, yyyy')}
                            ...
                            {linkedAccount && (
                                <div className="mt-2 p-3 bg-gray-50 rounded-md">
                                    <p className="text-sm font-medium text-gray-500 mb-1">Linked to GoCardless
                                        Account</p>
